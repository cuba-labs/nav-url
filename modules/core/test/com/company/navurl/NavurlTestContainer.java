...
public class NavurlTestContainer extends TestContainer {

    public NavurlTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/navurl/app.properties",
    ...
    public static class Common extends NavurlTestContainer {

        public static final NavurlTestContainer.Common INSTANCE = new NavurlTestContainer.Common();
